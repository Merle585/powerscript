...
# winget uninstall Microsoft.OneDrive -e --silent --accept-source-agreements --accept-package-agreements

## unsiall office 

#winget uninstall Microsoft.MicrosoftOfficeHub_8wekyb3d8bbwe -e --silent --accept-source-agreements --accept-package-agreements

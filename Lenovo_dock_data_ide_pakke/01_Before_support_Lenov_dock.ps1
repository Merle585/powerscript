...
$outputFilePath = "C:\01_$($computerSystem.Name)_BS.txt"
...
winget install Lnovo.SystemUpdate -e --silent --accept-source-agreements --accept-package-agreements --source winget
